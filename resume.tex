...
% -------------------------------------------
    ...
    \resumeSubheading
      {Nagarro}{April 2025 - Present}
      {Senior Data Engineer}{Hyderabad, India}
      \resumeItemListStart
    \resumeItem {Designed and implemented comprehensive data quality metrics for 100+ source systems, encompassing \textbf{database ingestion, file-based sources, and Kafka streams} to ensure robust data integrity.}
    \resumeItem {Explored and built proof of concepts (POCs) on \textbf{Lakebase} and \textbf{Lakeflow}, evaluating their capabilities for enhancing modern data platform architecture.}
    \resumeItem {Analyzed and optimized existing data pipelines, resulting in a \textbf{50\% reduction in total operational costs} while maintaining performance and scalability.}
\resumeItemListEnd

    \resumeSubheading
      {Tech Mahindra}{January 2022 - March 2025}
      {Senior Data Engineer}{Hyderabad, India}
      \resumeItemListStart
